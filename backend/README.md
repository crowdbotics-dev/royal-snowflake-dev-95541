...
## Project Structure
    ...
    ├── royal_snowflake_dev_95541  # Django project configurations
...
1. Clone this repo and `cd royal_snowflake_dev_95541`
...
2. Clone this repo and `cd royal_snowflake_dev_95541`
